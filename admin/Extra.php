...
class Extra {
	...
	public function type() {
        ...
        <select name="wpbkash_extra_fields[type]" id="type">
            <option value="percentage" <?php if ( isset( $this->options['type'] ) && $this->options['type'] == 'parcentage' ) echo 'selected="selected"'; ?>><?php esc_html_e( 'Percentage', 'wpbkash' ); ?></option>
            <option value="fixed" <?php if ( isset( $this->options['type'] ) && $this->options['type'] == 'fixed' ) echo 'selected="selected"'; ?>><?php esc_html_e( 'Fixed', 'wpbkash' ); ?></option>
        </select>
        <?php
	}
	...
	public function tax_class() {
        ...
        <select name="wpbkash_extra_fields[tax_class]" id="type">
            <option value="standard" <?php if ( isset( $this->options['tax_class'] ) && $this->options['tax_class'] == 'parcentage' ) echo 'selected="selected"'; ?>><?php esc_html_e( 'Standard', 'wpbkash' ); ?></option>
            <?php 
